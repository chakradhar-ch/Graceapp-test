					...
					<div class="card-body mt-5 " >
						<div className="mb-2">
							<label htmlFor="">
								...
								<p>Welcome to Adolphus Table!</p>

								<p>
									These terms and conditions outline the rules and regulations
									for the use of Adolphus Table's Website, located at
									adolphustable.com.
								</p>

								<p>
									By accessing this website we assume you accept these terms and
									conditions. Do not continue to use Adolphus Table if you do
								...
								<p>
									...
									law of us. Any use of the above terminology or other words in
								...
								<p>
									We employ the use of cookies. By accessing Adolphus Table, you
									agreed to use cookies in agreement with the Adolphus Table's
									Privacy Policy.{' '}
								</p>
								...
								<p>
									Unless otherwise stated, Adolphus Table and/or its licensors
									own the intellectual property rights for all material on
									Adolphus Table. All intellectual property rights are reserved.
									You may access this from Adolphus Table for your own personal
								...
								<p>You must not:</p>
								<ul>
									<li>Republish material from Adolphus Table</li>
									<li>
										Sell, rent or sub-license material from Adolphus Table
									</li>
									<li>
										Reproduce, duplicate or copy material from Adolphus Table
									</li>
									<li>Redistribute content from Adolphus Table</li>
								</ul>
								...
								<p>
									...
									website. Adolphus Table does not filter, edit, publish or
									review Comments prior to their presence on the website.
									Comments do not reflect the views and opinions of Adolphus
									Table,its agents and/or affiliates. Comments reflect the views
									and opinions of the person who post their views and opinions.
									To the extent permitted by applicable laws, Adolphus Table
								...
								<p>
									Adolphus Table reserves the right to monitor all Comments and
								...
								<p>
									You hereby grant Adolphus Table a non-exclusive license to
								...
								<p>
									...
									compensates the absence of Adolphus Table; and (d) the link is
								...
								<p>
									...
									inform us by sending an e-mail to Adolphus Table. Please
								...
								<p>
									No use of Adolphus Table's logo or other artwork will be
								...
								<p>
									Entries into the game (by picking a number) are limited to one
									per person per prize giveaway. Failure to abide by these rules
									gives us the right to disqualify you from winning any prizes.
								</p>
							</label>
						</div>
					</div>
